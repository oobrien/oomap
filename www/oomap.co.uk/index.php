...
<h1 style='margin: 40px 0 0 50px; font-size: 48px;'>OOMap</h1>
	<div style='float: left; width: 600px; height: 300px;  padding: 10px 30px 0 30px; margin: 30px 10px 30px 50px; border: 1px solid #aaa; background-color: white; opacity: 0.9;'>
		...
		OOMap provides bespoke consultancy services, including data analysis, web development and digital cartography. Some of our recent projects include:
	<div style='margin: 50px auto 50px auto;'>
		<div style='clear: both;'>Maps:
			<a href="http://simd.scot/" style='width: 30px; height: 30px; background-color: #060; margin: 0 20px 10px 0; padding: 15px 20px; color: white; text-align: center; vertical-align: middle; text-decoration: none; font-size: 24px;'>SIMD</a>
		Data:
			<a href="http://usp.scot/" style='width: 30px; height: 30px; background-color: #060; margin: 0 20px 10px 0; padding: 15px 20px; color: white; text-align: center; vertical-align: middle; text-decoration: none; font-size: 24px;'>USP (Flow data)</a>
		</div><div style='margin-top: 60px;'>Both:
			<a href="http://tubeheartbeat.com/" style='width: 30px; height: 30px; background-color: #060; margin: 0 20px 10px 0; padding: 15px 20px; color: white; text-align: center; vertical-align: middle; text-decoration: none; font-size: 24px;'>TubeHeartbeat</a>
			</div>
		</div>
	</div>
	...
	<div style='float: left; width: 600px; height: 300px;  padding: 10px 30px 0 30px; margin: 30px 10px 30px 50px; border: 1px solid #aaa; background-color: white; opacity: 0.9;'>
		...
		<div style='margin: 50px auto 50px auto;'>
			<a href="http://bikes.oobrien.com/" style='width: 30px; height: 30px; background-color: #08d; margin: 0 20px 10px 0; padding: 15px 20px; color: white; text-align: center; vertical-align: middle; text-decoration: none; font-size: 24px;'>Global</a>
			<a href="http://bikes.oobrien.com/london/" style='width: 30px; height: 30px; background-color: #08d; margin: 0 20px 10px 0; padding: 15px 20px; color: white; text-align: center; vertical-align: middle; text-decoration: none; font-size: 24px;'>London</a>
			<a href="http://bikes.oobrien.com/paris/" style='width: 30px; height: 30px; background-color: #08d; margin: 0 20px 10px 0; padding: 15px 20px; color: white; text-align: center; vertical-align: middle; text-decoration: none; font-size: 24px;'>Paris</a>
			<a href="http://bikes.oobrien.com/newyork/" style='width: 30px; height: 30px; background-color: #08d; margin: 0 20px 10px 0; padding: 15px 20px; color: white; text-align: center; vertical-align: middle; text-decoration: none; font-size: 24px;'>NYC</a>
		</div>
	</div>
	...
	<div style='float: left; width: 600px; height: 300px;  padding: 10px 30px 0 30px; margin: 30px 10px 30px 50px; border: 1px solid #aaa; background-color: white; opacity: 0.9;'>
		...
		<div style='clear: both;'>Social:
			<a href="http://twitter.com/oobr" style='width: 30px; height: 30px; background-color: #aaa; margin: 0 20px 10px 0; padding: 15px 20px; color: white; text-align: center; vertical-align: middle; text-decoration: none; font-size: 24px;'>Twitter</a>
			...
			<a href="http://oobrien.com/" style='width: 30px; height: 30px; background-color: #aaa; margin: 0 20px 10px 0; padding: 15px 20px; color: white; text-align: center; vertical-align: middle; text-decoration: none; font-size: 24px;'>Blog</a>
			<a href="http://portfolio.oobrien.com/" style='width: 30px; height: 30px; background-color: #aaa; margin: 0 20px 10px 0; padding: 15px 20px; color: white; text-align: center; vertical-align: middle; text-decoration: none; font-size: 24px;'>Portfolio</a>
			<a href="http://mappinglondon.co.uk/" style='width: 30px; height: 30px; background-color: #aaa; margin: 0 20px 10px 0; padding: 15px 20px; color: white; text-align: center; vertical-align: middle; text-decoration: none; font-size: 24px;'>Mapping London</a>
		</div>
	...
	<div style='position: absolute; bottom: 0; left: 10px; transform: rotate(-90deg); transform-origin: top left 0;'>&copy; Oliver O'Brien 2018</div>
	</body>
</html>
