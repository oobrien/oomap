...
$mapquery = "select id, title, race_instructions, eventdate, club, style, scale, papersize, paperorientation, centre_lat, centre_lon from map_old where shortcode = '$shortcode' limit 1";
...
$update_query = "update map_old set access_count = access_count + 1, last_accessed = now() where id = $map_id limit 1;";
@mysqli_query($conn, $update_query);

$controlquery = "select type, label, label_angle, score, lat, lon, description from control_old where map_id = $map_id";
