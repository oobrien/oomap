	...
	<body>
		<div id='toppanel'>
				<div id='editions'>
					...
					<div id='uk' class='currentedition'><a href="uk.php">&nbsp;  UK  &nbsp;</a></div>
					<div id='ireland'><a href="ioa.php">&nbsp;  Ireland  &nbsp;</a></div>
					<div id='wishlist' style='padding-top: 2px;'>Was this a useful service? Want to tip?<br />Here's a link to <a href="http://www.amazon.co.uk/registry/wishlist/2WLZDJ7S00ERD">my Amazon wish list</a>.</div>
				</div>
				<form id='search'>Postcode: <input type='text' size='10' id='postcode' />
					<button id='searchButton' type="submit">Jump</button>
				</form>
				<form id='load'>Load saved map #: <input type='text' size='10' id='savedMapID' />
					...
					<tr style='height: 27px'>
						<td rowspan='3' style='vertical-align: top;'>
							<div id="mapstyle" class="buttonset">
								<input type="radio" id="streeto" name="mapstyle" checked="checked" />
					...
					<tr style='height: 26px'>
						<td colspan='3'>	
							<div id="specialoptions">Special 
								...
								<button id='getPostboxes'>Add Postboxes</button>
		...
		<div id='mainpanel'>
			...
			<!-- <div id='supported'>
			Outside the UK? Try the <a href="http://oomap.co.uk/global.php">Global version</a>.
                               <div>OOMap.co.uk is supported by</div>
                                <a href="http://www.britishorienteering.org.uk/"><img src='images/bof2011.png' alt='British Orienteering' style='width: 156px; height: 74px; border-width: 0;' /></a>
			</div> -->
						<div id='sponsor'>
		...
		<div id="postboxes_searching" title="Searching" style='display: none;'>
			<table>
				<tr><td class="ui-icon ui-icon-info" style='margin: 0 7px 20px 0;'></td><td style='padding-bottom: 20px; vertical-align: top'>Retrieving local postboxes from dracos.co.uk Nearest Postbox project...</td></tr>
			</table>
		</div>
