...
ADORN_LOGO_SCALE = 0.038
ADORN_LOGO_SCALE_IOA = 0.25
ADORN_ARROW_W = 0.012
ADORN_LOGO_W = 0.018
...
def createJPG(path):
	...
	if style != "crew" and style != 'blueprint' and style != "urban_skeleton" and style != "streeto" and style != "oterrain" and style != "streeto_norail" and style != "adhoc" and style != "streeto_ioa" and style != "oterrain_ioa" and style != "streeto_norail_ioa" and style != 'streeto_global' and style != 'streeto_norail_global' and style != 'oterrain_global':
